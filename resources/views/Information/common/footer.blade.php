    ...
    <div class="container-fluid">
               ...
               <span class="mobile-logo hidden-1920 show-820">
                ...
                <div class="col-sm-10 footer-contactus col-lg-push-0 col-md-push-0 hidden-md hidden-lg col-sm-push-2">
                    ...
                    <form method="" action="">
                        ...
                        <div class="form-group row">
                            <label for="inputContactEmail" class="col-sm-3 form-control-label">@lang('app.email')</label>
                            <div class="col-sm-9">
        ...
        <div class="col-md-4 footer-contactus hidden-sm hidden-xs">
            ...
            <form method="" action="">
                ...
                <div class="form-group row">
                    <label for="input_contact_email" class="col-sm-2 form-control-label">@lang('app.email')</label>
                    <div class="col-sm-10">
                        <input type="email"  class="form-control contact-form-element" id="input_contact_email" />
                    </div>
                </div>
                <div class="form-group row">
